...
public class SpringRedisClusterConfig {
    ...
    public JedisCluster jedisCluster() throws Exception {
        ...
        hostAndPortList.add(new HostAndPort(host1, port1));
        hostAndPortList.add(new HostAndPort(host2, port2));

        JedisCluster jedisCluster = new JedisCluster(hostAndPortList, connectionTimeout, soTimeout, maxAttempts, password,
                jedisPoolConfig());
        return jedisCluster;
    }
}
