...
@Repository("SpringRedisSentinelInfoDao")
public class SpringRedisSentinelInfoDaoImpl implements IRedisInfoDao {
    private static final Logger logger = Logger.getLogger(SpringRedisSentinelInfoDaoImpl.class);
