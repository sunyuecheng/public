...
@Repository("UserInfoCurrentSessionDao")
public class UserInfoCurrentSessionDao implements IUserInfoCurrentSessionDao {
    private static final Logger logger = Logger.getLogger(UserInfoCurrentSessionDao.class);
